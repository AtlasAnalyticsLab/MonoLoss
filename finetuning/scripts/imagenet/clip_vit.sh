...
torchrun --nproc_per_node=1 --rdzv-endpoint="localhost:${RDZV_PORT}" train.py \
  ...
  --data-path /scratch/ntanh/imagenet/ --output-dir /scratch/ntanh/MonoLoss_results_vit \
  ...
  --interpolation bicubic --val-resize-size 224 --val-crop-size 224 --wandb-project monoloss-finetuning-vit --print-freq 100 \
